# This script allows you to compare a proposed list of resource types to be fed into an "Allowed Resources"
# policy in Azure to the existing resource types in use, and generates a report of which resources would be
# denied or audited if the proposed list were implemented.
...
Get-AzSubscription | ForEach-Object {
    ...
    Get-AzResource | ForEach-Object {
        if ($_.ResourceType -notin $proposedList) {
...
Write-Host "The following will be blocked:"
$blockedList | Format-List